<template>
  <div>
    <Header :picture="require('~/assets/partners.svg')" :title="title" :description="description">
      <div>
    ...
    <section id="investors" mb3>
      ...
      <Container>
        <TextWithSchema
          v-for="(partner, i) in partners.primary"
          :key="i"
          v-bind="partner"
          :reverse="i % 2 === 1"
          mb3
    ...
    <section id="partners" mb3>
      ...
      <Container>
        <TextWithSchema
          v-for="(partner, i) in partners.secondary"
          :key="i"
          v-bind="partner"
          :reverse="i % 2 === 1"
          mb3
...
import TextWithSchema from "~/components/TextWithSchema";
