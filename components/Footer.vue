    ...
    <div class="container-parent">
      <div class="container-child" flex row space-between justify-center align-center>
        <div class="logo" flex row space-between align-center>
          ...
          <div class="incubator">
            <p>Incubated by</p>
            <img src="~/assets/Partners/Yellow.png" alt="Yellow" class="yellow">
          </div>
        </div>
        <div class="container-nav" flex row align-center>
          ...
          <a href="https://docs.mesg.com/guide/start-here/quick-start-guide.html" target="_blank" class="nav">Get Started</a>
        </div>
      </div>
