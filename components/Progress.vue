<template>
  <section>
    <div class="container-parent">
      ...
      <div
        v-for="(progress, i) in usecase.progress"
        :key="i"
        ...
        space-between
      >
        <div :style="progressPicture(progress)" class="picture" half flex column></div>
        <div half flex column justify-center>
          <div flex row>
            <h3>{{ progress.title }}</h3>
            <p v-html="progress.text"></p>
          </div>
          <div flex row>
            <a :href="progress.link" target="_blank" class="link">
              Read the post
