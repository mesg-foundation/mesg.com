    ...
    <div class="container-parent">
      <div class="container-child" flex row space-between>
        ...
        <div thirdtwo flex column>
          ...
          <p>
            <small>
              <em>* These FAQs are intended only for informational purposes and shouldn’t be relied upon exclusively or considered as warranties. Please refer to GitHub and other resources for additional details.</em>
            </small>
          </p>
        </div>
      </div>
